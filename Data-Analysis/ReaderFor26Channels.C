 ...
 * TODO change data structure description
 * DATA STRUCTURE
...
const Int_t nChannelsPmt = 26;
const Int_t nTokensInRecord = 71;
const Int_t activeChannels[nChannelsPmt] = {}; //copy the order above
...
void fillEvent( Ev_t &Ev, Double_t* vRecord ) {
	//TODO modify this sequence following data description above
	Ssiz_t it=0;
